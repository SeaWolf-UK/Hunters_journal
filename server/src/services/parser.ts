...
const ALIASES: Record<string, { type?: string; size?: string; habitat?: string; ability?: string; damageType?: string; status?: string; movement?: string }> = {
  ...
  'swamp': { habitat: 'swamps, bogs, fens, marshes, murky wetlands' },
  'bog': { habitat: 'swamps, bogs, fens, marshes, murky wetlands' },
  'marsh': { habitat: 'swamps, bogs, fens, marshes, murky wetlands' },
  'forest': { habitat: 'forests, jungles, ancient woodlands, overgrown ruins' },
  'jungle': { habitat: 'forests, jungles, ancient woodlands, overgrown ruins' },
  'woods': { habitat: 'forests, jungles, ancient woodlands, overgrown ruins, dark forests' },
  'mountain': { habitat: 'mountains, volcanoes, rocky caves' },
  'volcano': { habitat: 'mountains, volcanoes, rocky caves' },
  'desert': { habitat: 'deserts, arid plains, rocky badlands, coastal cliffs' },
  'arid': { habitat: 'deserts, arid plains, rocky badlands, coastal cliffs' },
  'arctic': { habitat: 'arctic tundra, frozen mountains, glacial caves, ice sheets' },
  'tundra': { habitat: 'arctic tundra, frozen mountains, glacial caves, ice sheets' },
  'frozen': { habitat: 'arctic tundra, frozen mountains, glacial caves, ice sheets' },
  'underdark': { habitat: 'underdark caverns, deep subterranean vaults, forgotten temple complexes' },
  'underground': { habitat: 'underdark caverns, deep subterranean vaults, dungeons, underground corridors, ancient ruins, sewers, underdark outskirts, remote wilderness' },
  'cave': { habitat: 'caves, mountains, underdark outskirts, warrens, underground tunnel networks' },
  'dungeon': { habitat: 'dungeons, underground corridors, ancient ruins, sewers, ruins, ancient battlefields, crypts, tombs' },
  'ruin': { habitat: 'ruins, ancient battlefields, ruined towers, ruined mansions, forgotten temple complexes' },
  'tomb': { habitat: 'ancient tombs, ruined towers, hidden sanctums, crypts' },
  'crypt': { habitat: 'crypts, ancient tombs, ancient battlefields, tombs' },
  'grave': { habitat: 'graveyards, swamps' },
  'castle': { habitat: 'ancient castles, crypts, ruined mansions, urban underworld' },
...
const CREATURE_NAMES = [
  ...
  'lich', 'vampire', 'beholder', 'mind flayer', 'illithid', 'owlbear',
  'gelatinous cube', 'displacer beast', 'goblin', 'orc', 'troll', 'mimic',
  'ghost', 'skeleton', 'zombie', 'kobold',
];
