...
const ALIASES: Record<string, { type?: string; size?: string; habitat?: string; ability?: string; damageType?: string; status?: string; movement?: string }> = {
  ...
  'breaths fire': { ability: 'Fire Breath', damageType: 'fire' },
  'breath fire': { ability: 'Fire Breath', damageType: 'fire' },
  ...
  'breaths lightning': { ability: 'Lightning Breath', damageType: 'lightning' },
